...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->connect_error) {
        ...
        if ($result && $result->num_rows === 1) {
            ...
            $error_message = 'رقم الهاتف غير صحيح أو غير مسجل!';
        }
        $conn->close();
    }
}
...
<div class="register-page">
    <div class="register-form-container">
        ...
        <?php endif; ?>
        <h2 class="register-title">   تسجيل الدخول <span class="icon">🚀 </span></h2>
        <p class="register-desc">يمكنك الدخول إلى حسابك بإدخال رقم الهاتف وكلمة المرور الخاصة بك</p>
        <form class="register-form" method="POST" action="login.php">
            ...
            <button type="submit" class="register-submit">تسجيل الدخول</button>
        </form>
        <p class="register-login-link">لا يوجد لديك حساب؟ <a href="register.php">انشئ حسابك الآن !</a></p>
    </div>
...
<footer class="custom-footer">
  ...
  <div class="footer-content">
    <div class="footer-social">
      <!-- Facebook Icon -->
      <a href="https://www.facebook.com/share/15w8sZHijw/" target="_blank" rel="noopener noreferrer" class="footer-icon facebook">
      ...
      <!-- YouTube Icon -->
      <a href="https://www.facebook.com/share/15w8sZHijw/" target="_blank" rel="noopener noreferrer" class="footer-icon youtube">
        <svg width="54" height="54" viewBox="0 0 54 54">
