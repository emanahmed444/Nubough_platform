...
<head>
    ...
    <title>الصفوف الابتدائية - مكانك نبوغ</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="grades-section">
            <h1 class="page-title" data-aos="fade-down">الصفوف الابتدائية</h1>
            
            <div class="grade-item" data-aos="fade-left" data-aos-delay="100" onclick="selectGrade('الصف الأول الابتدائي')">
                <div class="grade-info">
                    <i class="fas fa-chevron-left grade-chevron"></i>
                    <span class="grade-text">الصف الأول الابتدائي</span>
                </div>
                <div class="grade-number">1</div>
            </div>

            <div class="grade-item" data-aos="fade-left" data-aos-delay="200" onclick="selectGrade('الصف الثاني الابتدائي')">
                <div class="grade-info">
                    <i class="fas fa-chevron-left grade-chevron"></i>
                    <span class="grade-text">الصف الثاني الابتدائي</span>
                </div>
                <div class="grade-number">2</div>
            </div>

            <div class="grade-item" data-aos="fade-left" data-aos-delay="300" onclick="selectGrade('الصف الثالث الابتدائي')">
                <div class="grade-info">
                    <i class="fas fa-chevron-left grade-chevron"></i>
                    <span class="grade-text">الصف الثالث الابتدائي</span>
                </div>
                <div class="grade-number">3</div>
            </div>

            <div class="grade-item" data-aos="fade-left" data-aos-delay="400" onclick="selectGrade('الصف الرابع الابتدائي')">
                <div class="grade-info">
                    <i class="fas fa-chevron-left grade-chevron"></i>
                    <span class="grade-text">الصف الرابع الابتدائي</span>
                </div>
                <div class="grade-number">4</div>
            </div>

            <div class="grade-item" data-aos="fade-left" data-aos-delay="500" onclick="selectGrade('الصف الخامس الابتدائي')">
                <div class="grade-info">
                    <i class="fas fa-chevron-left grade-chevron"></i>
                    <span class="grade-text">الصف الخامس الابتدائي</span>
                </div>
                <div class="grade-number">5</div>
            </div>

            <div class="grade-item" data-aos="fade-left" data-aos-delay="600" onclick="selectGrade('الصف السادس الابتدائي')">
                <div class="grade-info">
                    <i class="fas fa-chevron-left grade-chevron"></i>
                    <span class="grade-text">الصف السادس الابتدائي</span>
                </div>
        ...
        <div class="children-section">
            <img src="images/ابتداءي_جديد2-removebg-preview.png" alt="أطفال المدارس" class="children-image" data-aos="fade-right" data-aos-delay="800">
        </div>
    </div>
    ...
    <script>
        ...
        function selectGrade(grade) {
            ...
            setTimeout(() => {
                window.location.href = `subjects.php?grade=${encodeURIComponent(grade)}`;
            }, 800);
        }
