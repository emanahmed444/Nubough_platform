...
<head>
    ...
    <title>الصفوف الثانوية - منصة نبوغ</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="grades-section">
            <h1 class="page-title" data-aos="fade-down">الصفوف الثانوية</h1>
            
            <div class="grade-item" data-aos="fade-left" data-aos-delay="100" onclick="selectGrade('الصف الأول الثانوي')">
                <div class="grade-info">
                    <i class="fas fa-chevron-left grade-chevron"></i>
                    <span class="grade-text">الصف الأول الثانوي</span>
                </div>
                <div class="grade-number">1</div>
            </div>

            <div class="grade-item" data-aos="fade-left" data-aos-delay="200" onclick="selectGrade('الصف الثاني الثانوي')">
                <div class="grade-info">
                    <i class="fas fa-chevron-left grade-chevron"></i>
                    <span class="grade-text">الصف الثاني الثانوي</span>
                </div>
                <div class="grade-number">2</div>
            </div>

            <div class="grade-item" data-aos="fade-left" data-aos-delay="300" onclick="selectGrade('الصف الثالث الثانوي')">
                <div class="grade-info">
                    <i class="fas fa-chevron-left grade-chevron"></i>
                    <span class="grade-text">الصف الثالث الثانوي</span>
                </div>
        ...
        <div class="children-section">
            <img src="images/اعدادي2-removebg-preview.png" alt="طلاب المدارس" class="children-image" data-aos="fade-right" data-aos-delay="400">
        </div>
    </div>
    ...
    <script>
        ...
        function selectGrade(grade) {
            ...
            // redirect to unified subjects with level=sec and chosen grade
            const loading = document.getElementById('loading');
            loading.style.display = 'flex';
            setTimeout(() => {
                window.location.href = `subjects.php?grade=${encodeURIComponent(grade)}&level=sec`;
            }, 800);
        }
